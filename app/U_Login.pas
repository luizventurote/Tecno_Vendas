...
begin
    ...
    begin
      ...
      begin
        ...
        DM.id_usuario_ativo   := DM.M_UsuarioidUsuario.AsInteger;
        DM.nome_usuario_ativo := DM.M_Usuariologin.AsString;

        Application.CreateForm(TF_SISTEMA, F_SISTEMA);
        F_SISTEMA.show;
        F_LOGIN.Hide;

        DM.addLog('Usuário '+DM.usuario_ativo+' entrou no sistema.');
